...
import ru.sbercourse.cinema.ticketoffice.service.PlacementService;

@RestController
@RequestMapping("/placements")
@Tag(name = "Места", description = "Контроллер для работы с местами в кинозале")
public class PlacementController extends GenericController<Placement, PlacementDto> {

    public PlacementController(PlacementService placementService) {
        setService(placementService);
    }
}
